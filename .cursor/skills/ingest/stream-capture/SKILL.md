...
See `retrieval/dashboard` for S3 vs VastDB inventory, ingest quality, recent videos.
...
3. Check `/streaming/status` before starting. Only one capture runs at a time, per team.
